...
$sql = "select Fname,Mname,Lname,City,Salary from emp_detail";
...
<tr><th>Full Name</th><th>City</th><th>Salary</th></tr>
<?php 
	while($row = $result->fetch_assoc()) {
?>
	<tr><td><?php 	echo  $row["Fname"]. " " . $row["Mname"]." ".$row["Lname"] ."<br>";?></td>
	    <td><?php echo $row["City"] ?></td>
	    <td><?php echo $row["Salary"] ?></td></tr>
<?php 	
	}
}  
else {
